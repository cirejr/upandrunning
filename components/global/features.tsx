...
export default function Features() {
  return (
    <section className='dark:none bg-gradient-transparent mb-10 border-b border-t py-14 backdrop-blur-xl backdrop:filter'>
      <Separator
      ...
      <div className='mx-auto mb-7 max-w-7xl px-4 text-center sm:px-6 lg:px-8'>
        ...
        <p className='font-normal text-muted-foreground md:text-xl'>
